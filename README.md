...
├── 📁 topology
│   ├── 🖼️ logical_topology.png          # Topologi Logical Jaringan
│   ├── 🖼️ physical_topology_city.png     # Topologi Physical (Tampilan Kota & Gedung)
│   └── 🖼️ physical_topology_rack.png     # Topologi Physical (Tampilan Rak Server)
...
#### A. Main Stage Arena
* **Referees:** $(15 \times 30) / 5 = 90 \text{ Host}$
* **Ticketing:** $(144 \times 30) / 12 = 360 \text{ Host}$
* **Broadcasters:** $(30 \times 30) / 2 = 450 \text{ Host}$
* **Atlet:** $30 \times 30 = 900 \text{ Host}$ *(Kebutuhan Terbesar)*

#### B. Streaming Studio
* **Referees:** $2 \times 30 = 60 \text{ Host}$
* **Ticketing:** $(27 \times 30) / 9 = 90 \text{ Host}$
* **Broadcasters:** $2 \times (30 + 25) = 110 \text{ Host}$
* **Atlet:** $2 \times (30 + 15) = 90 \text{ Host}$

#### C. Bootcamp Area
* **Referees:** $30 + 5 = 35 \text{ Host}$
* **Ticketing:** $2 \times 30 = 60 \text{ Host}$
* **Broadcasters:** $(2 \times 30) + 66 = 126 \text{ Host}$
* **Atlet:** $((4 \times 30) / 20) \times 25 = 150 \text{ Host}$
...
## ⚙️ BAB 3: IMPLEMENTASI DAN KONFIGURASI
